...
const EventComment = ({
  ...
  const [isDeletingCommentOpen, setIsDeletingCommentOpen] =
    useState<boolean>(false);
  const [isDeletingCommentOpenError, setIsDeletingCommentError] =
    useState<boolean>(false);
      ...
      await axios
        ...
        .then(() => {
          ...
          if (tempCommentReplies.length) {
            const findCommentEventTempComment = tempCommentReplies.filter(
              (comment: any) => {
    ...
    >
      <div className={classes.nameDate}>
        <p className={classes.userName}>
          <Link to={`/profiles/${commentCreatorId}`}>
            {commentCreatorUsername}
          </Link>
        </p>

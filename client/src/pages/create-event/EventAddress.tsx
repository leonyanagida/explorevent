      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <TextField
            ...
            value={props.eventValues.createEventName}
          />
        </Grid>
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            value={props.eventValues.createEventStartDate}
          />
        </Grid>
        <Grid item xs={12} sm={6}>
          <TextField
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            value={props.eventValues.createEventEndDate}
          />
        </Grid>
        <Grid item xs={12} sm={6}>
          <TextField
          ...
          <>
            <Grid item xs={12} sm={7}>
              <TextField
                ...
                value={props.eventValues.createEventStreetAddress}
              />
            </Grid>
            <Grid item xs={12} sm={5}>
              <TextField
                ...
                value={props.eventValues.createEventCity}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={8}>
              <TextField
                ...
                value={props.eventValues.createEventZip}
              />
            </Grid>
          </>
        )}
